...
<head>
    <meta charset="utf-8">
    <title>account/operations/account.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">account/operations/account.js</h1>
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Account.prototype.storageContainersListNext = function (nextLink, options, callback) {
  var client = this.client;
  if(!callback &amp;&amp; typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Account.prototype.sasTokensListNext = function (nextLink, options, callback) {
  var client = this.client;
  if(!callback &amp;&amp; typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Account.prototype.storageContainersListNextNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback &amp;&amp; typeof options === 'function') {
    callback = options;
    options = null;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
Account.prototype.sasTokensListNextNext = function (nextPageLink, options, callback) {
  var client = this.client;
  if(!callback &amp;&amp; typeof options === 'function') {
    callback = options;
    options = null;
