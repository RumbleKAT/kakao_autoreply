 ...
 *
 */
function ServerManagement(credentials, subscriptionId, baseUri, options) {
  ...
  ServerManagement['super_'].call(this, credentials, options);
  ...
  this.node = new operations.Node(this);
  this.session = new operations.Session(this);
  this.powerShell = new operations.PowerShell(this);
  this.models = models;
  msRest.addSerializationMixin(this);
}

util.inherits(ServerManagement, ServiceClient);
